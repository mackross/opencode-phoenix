defmodule Opencode.Phoenix.Guardrails do
  @moduledoc false

  alias Opencode.Phoenix.Guardrails.Issue
  alias Opencode.Phoenix.Guardrails.Rules
  ...
  defp files_to_scan(root) do
    ...
    |> Enum.reject(fn file ->
      ...
      String.starts_with?(relative, "lib/opencode/phoenix/guardrails")
    end)
  end
end
